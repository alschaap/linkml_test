# Contributing to schema_test

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
schema_test. These guidelines are not strict rules.
...
The schema_test team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the schema_test technical leads
...
[issues]: https://github.com/alschaap/schema_test/issues/
[pulls]: https://github.com/alschaap/schema_test/pulls/
